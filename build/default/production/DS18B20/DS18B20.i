...
# 52 "C:\Program Files (x86)\Microchip\xc8\v2.10\pic\include\pic16f628a.h"
...
OneWireRelease();
_delay((unsigned long)((240)*(20000000/4000000.0)));
_delay((unsigned long)((240)*(20000000/4000000.0)));
OneWireHigh();
_delay((unsigned long)((70)*(20000000/4000000.0)));
unsigned int OW = OneWireRead();
_delay((unsigned long)((205)*(20000000/4000000.0)));
_delay((unsigned long)((205)*(20000000/4000000.0)));
OneWireHigh();
return OW;
}
...
if(b){
OneWireRelease();
_delay((unsigned long)((6)*(20000000/4000000.0)));
OneWireHigh();
_delay((unsigned long)((64)*(20000000/4000000.0)));
}
else{
OneWireRelease();
...
_delay((unsigned long)((6)*(20000000/4000000.0)));
OneWireHigh();
_delay((unsigned long)((9)*(20000000/4000000.0)));
unsigned char out = OneWireRead();
_delay((unsigned long)((55)*(20000000/4000000.0)));
return out;
}
